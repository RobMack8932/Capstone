      ...
      <main>
        <body>
          ...
          <div class="ProteinLinks">
            <Link className="btn btn-success mr-2" to={'/VegetarianItalian'}>
              Italian
            </Link>
            <Link className="btn btn-success mr-2" to={'/VegetarianAsian'}>
              Asian
            </Link>
            <Link className="btn btn-success mr-2" to={'/VegetarianMexican'}>
              Mexican
            </Link>
          </div>
        </body>
