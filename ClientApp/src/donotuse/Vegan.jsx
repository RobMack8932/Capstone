      ...
      <main>
        <body>
          ...
          <div class="ProteinLinks">
            <Link className="btn btn-success mr-2" to={'/VeganItalian'}>
              Italian
            </Link>
            <Link className="btn btn-success mr-2" to={'/VeganAsian'}>
              Asian
            </Link>
            <Link className="btn btn-success mr-2" to={'/VeganMexican'}>
              Mexican
            </Link>
          </div>
        </body>
